...
st.write("**Debug: First 5 rows, first 10 columns**")
...
if query:
    ...
    st.success(f"✅ Found {len(res)} matching rows for '{query}'")
    ...
    if len(res) > 0:
        ...
        st.warning("No matches found. Check debug table above for column structure.")
